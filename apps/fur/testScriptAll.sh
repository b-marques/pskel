...
APP_NAME="fur"
EXECUTABLE="run.sh"
TEST_DIRECTORY="tests/Experiments/furExperimentsEUROPAR/"
...
#mkdir -p tests/Experiments/furExperimentsEUROPAR/

for INPUT_SIZE in 2048 4096 8192 12288
do
  for TILE_SIZE in 32 64 128
  do
    mkdir -p tests/Experiments/furExperimentsEUROPAR/spec${INPUT_SIZE}${TILE_SIZE}/
